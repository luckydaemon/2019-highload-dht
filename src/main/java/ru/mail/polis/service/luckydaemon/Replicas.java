...
public final class Replicas {
    ...
    public static Replicas calculateRF(final String replics, final int clusterSize, @NotNull final HttpSession session, final Replicas defaultRF) throws IOException {
        Replicas repl = null;
        try {
